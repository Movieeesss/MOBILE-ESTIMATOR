    ...
    <div style={{ maxWidth: '600px', margin: '0 auto', background: '#f1f5f9', minHeight: '100vh', paddingBottom: '160px', position: 'relative' }}>
      ...
      <div style={{ padding: '8px' }}>
        {computedData.processed.map((sec) => (
          <div key={sec.id} style={{ background: '#fff', marginBottom: '12px', borderRadius: '8px', border: '1px solid #cbd5e1', overflow: 'hidden' }}>
      ...
      <div style={stickyFoot}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
          <span style={{ fontSize: '12px', fontWeight: 'bold', color: '#64748b' }}>TOTAL</span>
